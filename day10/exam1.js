/* 
함수(function) : 미리 정의된 코드/수, 함(상자) 수(숫자/코드)
...
// * 함수호출
// 5) 호출 함수명   6) ( 인자값 )   , * 3 이라는 인자값이 매개변수1 에 저장된다.
func1( 3 ); 
...
let 컵1 = 믹서기함수( '사과' ) // 믹서기함수에 사과를 인자값으로 전달 하여 사과주스 반환하여 컵1에 저장 
...
if( true ){
    let 지역변수1 = ' 경기도 ' // 2] 해당 변수는 if{ } 에서 선언된 함수
