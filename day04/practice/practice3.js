...
// 10,000원 미만: 할인 없음
let 구매금액 = Number(prompt('구매금액을 입력하세요:'))
if(구매금액>=50000){console.log(구매금액*0.9)}
else if (구매금액>=30000 ){console.log(구매금액*0.95)}
else if (구매금액>=10000 ){console.log(구매금액*0.99)}
else(console.log('할인된 금액이 없습니다.'))
...
let 월 =Number(prompt('1~12 월을 입력하세요.'))
if(월>=3 && 5>=월 ){console.log('해당 월은 봄입니다.')}
else if(월>=6 && 8>=월 ){console.log('해당 월은 여름입니다.')}
else if (월>=9 && 11>=월 ){console.log('해당 월은 가을입니다.')}
else if (월=12 && 2>=월 ){console.log('해당 월은 겨울입니다.')}
...
let 연도 = Number(prompt('년도를 입력하세요.'))
if ((연도%4 == 0 && 연도%100 != 0 )||연도%400 == 1){console.log(연도 + '년은 윤년입니다.')}
else{console(연도 + '년은 평년입니다.')}
...
let courseList = ['수학', '영어', '과학', '국어'];
let subject = prompt('제외할 과목 입력');

let index = courseList.indexOf(subject);
