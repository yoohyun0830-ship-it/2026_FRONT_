...
// let 국어점수 = prompt( '국어점수:' ) // 1. 입력받기 2.입력 받은 값을 변수에 저장
// let 영어점수 = prompt( '영어점수:' ) // *주의할점 : prompt 함수는 입력받은 값을 문자열 타입 반환
// let 수학점수 = prompt( '수학점수:' ) // 100 입력하면 문자 100 *타입변환*
// //( 3 + ( 3 - 1) ) : 안쪽소괄호 부터 처리
// // let 수학점수 = Number( prompt ('수학점수:') )
// // 1. prompt( '수학점수:' ) : 처리되고 입력받은 값으로 반환 된다. 예]"90"
// let 총점 = Number(국어점수) +  Number(영어점수) +  Number(수학점수) // 3. 변수(입력받은값) 연산 // * 각 변수에는 입력받은 값이 존재
// let 평균 = 총점 / 3
