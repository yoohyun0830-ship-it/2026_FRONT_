// [ 문제] 아래 연산자 관련 10문제 , 단] if(제어문), for(반목문) 은 사용하지 않습니다.
...
// let 출생년도 = Number(prompt("출생년도 입력:"))
// let 현재나이 = 2025 - 출생년도
...
// let id = prompt('id 입력:')
// let email = prompt('email 입력:')
// let 결과1 = id == 'admin' ? id + "(관리자)" : id +"(일반 사용자)"
// let 결과2 = email == 'admin@test.com' ? email + "(관리자)" : email + "(일반 사용자)"
...
// 80점 이상 90점 미만: 'B'
// 70점 미만: 'C'  
// let 점수 = Number(prompt('점수입력: '))
// let 등급 = 점수 >= 90 ? 'A': 점수 >= 80 && 점수 <90 ? 'B' : 'C'
...
// let 나이 = Number(prompt('나이입력:'))
// let 이벤트대상 = 나이 >=20 && 나이 <29 ? " 이벤트 대상입니다." : "이벤트 대상이 아닙니다."
// console.log(`이벤트대상:  ${이벤트대상 }`)
...
let 마지막대기자 = waitingList[waitingList.length - 1]
console.log(`마지막대기자는 ${마지막대기자} 입니다.`)
